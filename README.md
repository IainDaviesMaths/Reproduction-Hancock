...
To use this code, first clone the repository then run the makefile using "make all" to execute the MATLAB code and "make run-julia" to execute the Julia code. Code was originally written in MATLAB then converted to Julia. Both MATLAB and Julia code are provided in this repository.
...
The Matlab code was run using MATLAB v9.6 and Image Processing Toolbox v10.4. The full list of Julia dependencies is given in julia-code/Project.toml
